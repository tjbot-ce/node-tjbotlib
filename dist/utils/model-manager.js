...
export class ModelManager {
     ...
     */
    getSupportedSTTModels() {
        return this.getSupportedModels('stt');
    }
    /**
     * Supported TTS models (full metadata)
     */
    getSupportedTTSModels() {
        return this.getSupportedModels('tts');
    }
    /**
     * Supported VAD models (full metadata)
     */
    getSupportedVADModels() {
        return this.getSupportedModels('vad');
    }
    /**
     * Supported Vision models (full metadata)
     */
    getSupportedVisionModels() {
        return this.getSupportedModels('vision');
    }
    /**
     ...
     */
    validateModelFilesExist(modelKey) {
        ...
        for (const model of this.models.filter((m) => m.type === modelType)) {
            ...
            if (fs.existsSync(modelPath)) {
                ...
                if (this.validateModelFilesExist(model.key)) {
                    ...
                    winston.warn(`One or more model files are missing for installed model ${model.key}. Please remove this model from ${modelPath} and re-download this model.`);
                }
            }
            else {
     ...
     */
    getInstalledSTTModels() {
        return this.getInstalledModels('stt');
    }
    /**
    ...
    getInstalledTTSModels() {
        return this.getInstalledModels('tts');
    }
    /**
     * List installed VAD models
     * @returns List of installed VAD models
     */
    getInstalledVADModels() {
        return this.getInstalledModels('vad');
    }
    /**
     * List installed Vision models
     * @returns List of installed Vision models
     */
    getInstalledVisionModels() {
        return this.getInstalledModels('vision');
    }
    // ===========================================================================
    // Model Size Fetching
    // ===========================================================================
