...
export function resolveCredentialsPath(providedPath?: string): string | undefined {
    if (providedPath) {
...
export function loadCredentialsFromFile(credentialsPath: string): { subscriptionKey: string; region: string } {
